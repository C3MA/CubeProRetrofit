...
#define CUSTOM_MACHINE_NAME "CubePro_Duo"
...
//#define HOTEND_OFFSET_X {0.0, 42.25} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define DUMMY_THERMISTOR_999_VALUE 88
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // CubePro Duo M303 E0 C5 S245 20180525
  //#define  DEFAULT_Kp 16.97
  //#define  DEFAULT_Ki 3.24
  //#define  DEFAULT_Kd 22.25

  // CubePro Duo M303 E1 C5 S245 20180829
  // RECHTER EXTRUDER
  //#define DEFAULT_Kp 26.97
  //#define DEFAULT_Ki 4.64
  //#define DEFAULT_Kd 39.21
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // M106 S255
  // M303 E-1 C8 S110 20180829
  // FANS OFF:
  //#define DEFAULT_bedKp 296.80
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 87.5, 87.5, 1075, 78, 78 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 80, 80, 8, 40, 40 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 400, 8000, 8000 }
 ...
 */
#define DEFAULT_XJERK                 1.8
#define DEFAULT_YJERK                 1.8
#define DEFAULT_ZJERK                 0.15
#define DEFAULT_EJERK                 1.8
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 230, 255, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   { 245, 270, (Z_MIN_POS + 1)}
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 40       // Number of LEDs in the strip
  #define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 120  // Initial brightness (0-255)
